...
export default function RegisterScreen() {
  ...
  const handleCreateVault = async () => {
    try {
      const response = await fetch('http://192.168.1.15:8080/api/v1/auth/register', {
        method: 'POST',
        headers: {
      ...
      >
        ...
        >
          ...
          <View style={styles.statusRow}>
            ...
            <Text style={styles.statusText}>CREATING SECURE SHARDS</Text>
          </View>
